...
class SubmitURL {
    constructor(config) {
        ...
        this.siteHost = new url_1.URL(this.siteURL).host;
    ...
    toGoogle(urlList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const jwtClient = new googleapis_1.google.auth.JWT(this.googleClientEmail, null, this.googlePrivateKey, ['https://www.googleapis.com/auth/indexing'], null);
